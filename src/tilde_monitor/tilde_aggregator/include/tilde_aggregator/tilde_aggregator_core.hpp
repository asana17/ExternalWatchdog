...
private:
  ...
  void onMessageTrackingTag(const tilde_msg::msg::MessageTrackingTag::ConstSharedPtr msg);
  ...
  std::optional<MessageTrackingTagStamped> getLatestMessageTrackingTag(
    const std::string & end_topic_name) const;
  std::optional<MessageTrackingTagStamped> getMessageTrackingTag(
  ...
  std::optional<MessageTrackingTagStamped> findStartPoint(
